            ...
            try
            {
                ...
                ChatCompletion completion = chatClient.CompleteChat(
                    new List<ChatMessage>() {
                        new UserChatMessage ("You are a Web of Things Thing Description generator."),
                        new UserChatMessage(@"Generate a Web of Things Thing Description for a Siemens Sentron PAC4200"),
                        new UserChatMessage (chatResponseSample),
                ...
                string autogeneratedConfig = completion.Content[0].Text;
