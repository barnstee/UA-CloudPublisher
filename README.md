...
* AZURE_OPENAI_API_ENDPOINT - Azure OpenAI service (ChatGPT) endpoint, e.g. https://wotgpt4.openai.azure.com/ 
...
* AZURE_OPENAI_API_DEPLOYMENT_NAME - Deployment or model name used in the Azure OpenAI service (ChatGPT).
